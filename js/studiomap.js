...
var RISKLAYERS = ['east1', 'east2', 'east3', 'east4', 'east5', 'east6', 'south1', 'south2', 'south3', 'south4', 'south5', 'south6', 'midwest1', 'midwest2', 'midwest3', 'midwest4', 'midwest5', 'midwest6', 'west1', 'west2', 'west3', 'west4', 'west5', 'west6', 'easthover', 'southhover', 'midwesthover', 'westhover'];
    ...
    map.on("mousemove", function (e) {
        map.featuresAt(e.point, {
            ...
            if (!err && features.length) {
                ...
                document.getElementById('tooltip').innerHTML = "Tract: " + features[0].properties.NAME + "<br />Risk: " + Math.round(features[0].properties.risk);
...
// Hide areas in groups 1-3 (low risk)
